...
_str = str
_DType = TypeVar(
    "_DType", str, bool, int, float, object, _np.ndarray, List, covariant=True
)
_DType2 = TypeVar(
    "_DType2", str, bool, int, float, object, _np.ndarray, List, covariant=True
)
...
class Series(Generic[_DType]):
    ...
    @overload
    def __getitem__(
        self, idx: Union[List[_str], Index[int], Series, slice]
    ) -> Series: ...
    @overload
    ...
    def __truediv__(
        self, other: Union[_Number, Series[_Number]]
    ) -> Series[_Number]: ...
    @property
    ...
    def replace(
        self,
        to_replace: Sequence[_DType2],
        value: Sequence[_DType2],
        inplace: Literal[False] = ...,
    ) -> Series[_DType]: ...
    @overload
    def replace(
    ...
    @overload
    def replace(
        self, to_replace: _DType2, value: _DType2, inplace: Literal[True]
    ) -> None: ...
