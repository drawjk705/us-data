...
from typing import Any, Callable, Dict, Generic, Iterator, List, Mapping, Optional, Sequence, Set, Tuple, Type, TypeVar, Union, overload
from typing_extensions import Literal
from .indexing import _AtIndexerSeries, _LocIndexerSeries, _iLocIndexerSeries
...
_DTypeNp = TypeVar("_DTypeNp", _np.bool_, _np.int8, _np.int16, _np.int32, _np.int64, _np.float32, _np.float64, _np.str_)
class Series(Generic[_DType]):
    def __init__(self, data: Optional[Union[_ListLike[_DType], Series[_DType], Dict[int, _DType], Dict[_str, _DType], int]], index: Union[_str, int, Series, Index, range] = ...) -> None:
        ...
    ...
    def append(self, to_append: Union[Series, Sequence[Series]], ignore_index: bool = ..., verify_integrity: bool = ...) -> Series:
        ...
    ...
    def corr(self, other: Series, method: Literal["pearson", "kendall", "spearman"] = ...) -> float:
        ...
    ...
    @overload
    def drop(self, labels: Union[_str, List[_str], Index], axis: _AxisType = ..., inplace: bool = ...) -> Series[_DType]:
        ...
    ...
    @overload
    def fillna(self, value: Union[_DType, Dict, Series, DataFrame], method: _str = ..., axis: Optional[_AxisType] = ..., inplace: Literal[True] = ..., limit: int = ..., downcast: Dict = ...) -> None:
        ...
    
    @overload
    def fillna(self, value: Union[_DType, Dict, Series, DataFrame], method: _str = ..., axis: Optional[_AxisType] = ..., inplace: Literal[False] = ..., limit: int = ..., downcast: Dict = ...) -> Optional[Series]:
        ...
    ...
    def rank(self, axis: _AxisType = ..., method: Literal["average", "min", "max", "first", "dense"] = ..., numeric_only: Optional[bool] = ..., na_option: Literal["keep", "top", "bottom"] = ..., ascending: bool = ..., pct: bool = ...) -> Series[float]:
        ...
    
    @overload
    def replace(self, to_replace: Sequence[_DType2], value: Sequence[_DType2], inplace: Literal[False] = ...) -> Series[_DType]:
        ...
    
    @overload
    def replace(self, to_replace: Sequence[_DType2], value: Sequence[_DType2], inplace: Literal[True]) -> None:
        ...
    
    @overload
    def replace(self, to_replace: _DType2, value: _DType2, inplace: Literal[False] = ...) -> Series[_DType]:
        ...
    ...
    @overload
    def sort_values(self, inplace: Optional[Literal[False]] = ..., ascending: bool = ...) -> Series[_DType]:
        ...
    
    def shift(self, periods: int = ..., freq: Optional[_str] = ..., axis: Optional[_AxisType] = ..., fill_value: Optional[object] = ...) -> Series[_DType]:
        ...
