...
class _ExtensionArray:
    ...
    def to_numpy(self, dtype: Optional[_DtypeObj] = ..., copy: bool = ..., na_value: Optional[Any] = ...) -> np.ndarray:
        ...
    ...
    def fillna(self, value: Union[_ScalarLike, _ArrayLike] = ..., method: Optional[Literal["backfill", "bfill", "pad", "ffill"]] = ..., limit: Optional[int] = ...) -> _ExtensionArray:
        ...
    ...
    def searchsorted(self, value: _ArrayLike, side: Optional[Literal["left", "right"]] = ..., sorter: Optional[_ArrayLike] = ...) -> np.ndarray:
        ...
    ...
    def repeat(self, repeats: Union[int, np.ndarray], axis: Optional[int] = ...) -> _ExtensionArray:
        ...
    
    def take(self, indices: Sequence[int], allow_fill: bool = ..., fill_value: Any = ...) -> _ExtensionArray:
        ...
