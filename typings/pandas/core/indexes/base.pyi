...
import numpy as _np
from typing import Callable, Generic, Iterator, List, Optional, Set, Tuple, Type, TypeVar, Union, overload
...
class Index(Generic[_T]):
    def __init__(self, data: _ArrayLike[_T], dtype: Optional[_np.dtype] = ..., copy: Optional[bool] = ..., name: Optional[_str] = ..., tupleize_cols: Optional[bool] = ...) -> None:
        ...
    ...
    def __ne__(self, other: _str) -> Index[_T]:
        ...
    ...
    def isin(self, values: Union[Set, _ArrayLike], level: Union[_str, int] = ...) -> _np.ndarray[_np.bool_]:
        ...
