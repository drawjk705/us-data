...
class BaseMaskedArray(ExtensionArray, ExtensionOpsMixin):
    ...
    def to_numpy(self, dtype: Optional[_DtypeObj] = ..., copy: bool = ..., na_value: _ScalarLike = ...) -> np.ndarray:
        ...
    ...
    def take(self: _BaseMaskedArrayT, indexer: Sequence, allow_fill: bool = ..., fill_value: Optional[_ScalarLike] = ...) -> _BaseMaskedArrayT:
        ...
