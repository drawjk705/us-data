...
class DataFrame:
    ...
    def __getitem__(
        self,
        idx: Union[Series, DataFrame, List[_str], Index[_str], _np.ndarray[_np.str_]],
    ) -> DataFrame: ...
    ...
    def append(
        self,
        s: Union[DataFrame, Dict[_str, Any]],
        ignore_index: bool = ...,
        sort: bool = ...,
    ) -> DataFrame: ...
    def apply(
    ...
    def corr(
        self, method: Optional[_str] = ..., min_periods: Optional[int] = ...
    ) -> DataFrame: ...
    ...
    @overload
    def itertuples(
        self, name: Literal[None], index: bool = ...
    ) -> Iterator[Tuple[Any, ...]]: ...
    @overload
    ...
    @overload
    def rename(
        self, *, columns: _Renamer, inplace: Literal[False] = ...
    ) -> DataFrame: ...
    @overload
    def rename(self, *, index: _Renamer, inplace: Literal[True]) -> None: ...
    @overload
    def rename(
        self, *, index: _Renamer, inplace: Literal[False] = ...
    ) -> DataFrame: ...
    def replace(
        self,
    ...
    @overload
    def sample(
        self, frac: float, random_state: int = ..., replace: bool = ...
    ) -> DataFrame: ...
    @overload
    def sample(
        self, n: int, random_state: int = ..., replace: bool = ...
    ) -> DataFrame: ...
    @overload
    def sample(
        self, n: int, random_state: int = ..., axis: _AxisType = ...
    ) -> DataFrame: ...
    @overload
