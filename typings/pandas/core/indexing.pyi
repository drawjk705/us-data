...
class _LocIndexerFrame:
    ...
    @overload
    def __getitem__(self, idx: Tuple[Union[slice, _MaskType, _IndexType, List[str]], Union[_MaskType, List[str], str]]) -> DataFrame:
        ...
    ...
    @overload
    def __setitem__(self, idx: Union[_MaskType, _IndexType], value: Union[float, _np.ndarray, DataFrame]) -> None:
        ...
    ...
    @overload
    def __setitem__(self, idx: List[_StrLike], value: Union[float, _np.ndarray, DataFrame]) -> None:
        ...
    ...
    @overload
    def __setitem__(self, idx: Tuple[Union[_MaskType, _IndexType, List[str]], Union[_MaskType, List[str]]], value: Union[DataFrame, Series, float]) -> None:
        ...
