...
import numpy as _np
from typing import Generic, Hashable, List, Tuple, Union, overload
...
class _iLocIndexerFrame:
    ...
    @overload
    def __setitem__(
        self, idx: _IndexType, value: Union[float, Series, DataFrame]
    ) -> None: ...
    @overload
    def __setitem__(
    ...
    @overload
    def __setitem__(
        self, idx: Tuple[_IndexType, int], value: Union[float, Series]
    ) -> None: ...
    @overload
    def __setitem__(
        self, idx: Tuple[int, _IndexType], value: Union[float, Series]
    ) -> None: ...
...
class _iLocIndexerSeries(Generic[_DType]):
    ...
    @overload
    def __setitem__(
        self, idx: _IndexType, value: Union[_DType, Series[_DType]]
    ) -> None: ...
...
class _LocIndexerFrame:
    ...
    def __getitem__(
        self,
        idx: Tuple[
            Union[slice, _MaskType, _IndexType, List[str]],
            Union[_MaskType, List[str], str],
        ],
    ) -> DataFrame: ...
    @overload
    ...
    def __setitem__(
        self,
        idx: Union[_MaskType, _IndexType],
        value: Union[float, _np.ndarray, DataFrame],
    ) -> None: ...
    @overload
    def __setitem__(
        self, idx: _StrLike, value: Union[float, Series, _np.ndarray]
    ) -> None: ...
    @overload
    def __setitem__(
    ...
    @overload
    def __setitem__(
        self, idx: Tuple[_IndexType, str], value: Union[_IndexType, float]
    ) -> None: ...
    @overload
    def __setitem__(
        self,
        idx: Tuple[
            Union[_MaskType, _IndexType, List[str]], Union[_MaskType, List[str]]
        ],
...
class _AtIndexerFrame:
    ...
    def __setitem__(
        self, idx: Tuple[int, Hashable], value: Union[int, float, str]
    ) -> None: ...
