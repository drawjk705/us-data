...
"""
class StringMethods:
    def contains(self, pat: str, case: bool = ..., flags: int = ..., na: float = ..., regex: bool = ...) -> Series[bool]:
        ...
    ...
    def slice_replace(self, start: Optional[int], stop: Optional[int], repl: Optional[str]) -> Series:
        ...
    ...
    def wrap(self, width: int, expand_tabs: Optional[bool], replace_whitespace: Optional[bool], drop_whitespace: Optional[bool], break_long_words: Optional[bool], break_on_hyphens: Optional[bool]) -> Series:
        ...
