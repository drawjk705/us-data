...
class SeriesGroupBy(GroupBy):
    ...
    def rank(self, method: Literal["average", "min", "max", "first", "dense"] = ..., ascending: bool = ..., na_option: Literal["keep", "top", "bottom"] = ..., pct: bool = ...) -> Series:
        ...
...
class DataFrameGroupBy(GroupBy):
    ...
    def aggregate(self, func: Union[_FunctionLike, List[_FunctionLike], Dict[_str, _FunctionLike]]) -> DataFrame:
        ...
